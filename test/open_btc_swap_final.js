...
async function main() {
  ...
  // Use the exact same format as successful historical orders
  const params = {
    symbol: symbol,  // Required for validation
    product: symbol,  // Actual field used by API
    side: 'buy',
    type: 'limit',
    quantity: quantity,
    price: String(price),
    ...
    positionMerge: 'long',
    timeInForce: 'gtc',
    origin: 1,  // Added origin field based on successful orders
    mini: false,
    stf: 'disabled',
    close: false,
    postOnly: false
